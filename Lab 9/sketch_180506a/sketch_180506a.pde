...
void draw()
{
    // Uncomment function you want to show
    
                  // Change the parameter to change the size of the bins 
    //pixelateImage(20);
    
                  // Change the parameter to "red", "green" and "blue" to see a different pixelated image 
